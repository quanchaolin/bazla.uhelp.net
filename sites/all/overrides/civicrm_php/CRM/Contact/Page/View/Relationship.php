...
class CRM_Contact_Page_View_Relationship extends CRM_Core_Page {
  ...
  function browse() {
    ...
    ///////////////////////////////////////////////////////////////
    //OVERRIDE FOR HELP UHELP OPENFLOWS BY MARK LIBKUMAN 2013-12-14
    if (function_exists('uhelp_modify_relationship_contact_names')) {

      uhelp_modify_relationship_contact_names($this->_contactId,
					      $currentRelationships,
					      $inactiveRelationships);
    }
    //END OVERRIDE HELP UHELP OPENFLOWS BY MARK LIBKUMAN 2013-12-14
    ///////////////////////////////////////////////////////////////
